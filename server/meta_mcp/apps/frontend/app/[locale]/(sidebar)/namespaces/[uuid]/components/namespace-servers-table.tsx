...
import {McpServerErrorStatusEnum, McpServerTypeEnum, NamespaceServer,} from "@repo/zod-types";
import {
    ColumnDef,
    flexRender,
    getCoreRowModel,
...
import {ArrowUpDown, Copy, ExternalLink, Eye, FileText, MoreHorizontal, Search, Server,} from "lucide-react";
